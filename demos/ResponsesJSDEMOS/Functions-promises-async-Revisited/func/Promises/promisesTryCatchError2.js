...
/* 
Here , we are catching an error , however ,  
instead of logging it to the console , by 
"Catching" , the error , like so 
...
//-----------------------------------------------------------------
 ...
 Or instead of creating a new error like
...
// 2./
//-----------------------------------------------------------------------
// let error1 = new Error("This was an error")
